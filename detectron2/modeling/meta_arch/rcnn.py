...
from .custom_attention import FeatureRefiner
...
class GeneralizedRCNN(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        rpn_in_features = cfg.MODEL.RPN.IN_FEATURES
        
        # FeatureRefiner (Stacked CBAM)
        self.fpn_refiner = FeatureRefiner(
    ...
    def forward(self, batched_inputs):
        ...
        # Compute Features from Backbone 
        ...
        ###
        # Apply Feature Refinement (Stacked CBAM)
        features = self.fpn_refiner(features)
        
        # NOTE: The subsequent if-block in the original code is redundant and
        # was commented out/misplaced, I'm integrating the proposal generation
        # directly into the flow below.
    ...
    def inference(self, batched_inputs, detected_instances=None, do_postprocess=True):
        ...
        # --- Apply Feature Refinement (Stacked CBAM) during inference ---
        features = self.fpn_refiner(features)
